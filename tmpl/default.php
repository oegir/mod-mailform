...
?>
<<?php echo $module_tag ?> class="<?php echo $classes ?>">
	...
	<div class="modal hide fade"
		id="modMailformWindow_<?php echo $module->id ?>">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"
				id="modMailformTopClose_<?php echo $module->id ?>"
				aria-hidden="true">×</button>
		<?php if ((bool) $module->showtitle) :?>
			<<?php echo $headerTag ?> class="<?php echo $classes ?>"><?php echo $module->title; ?></<?php echo $headerTag; ?>>
		<?php endif; ?>
